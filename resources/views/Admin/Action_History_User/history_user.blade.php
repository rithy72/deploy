                ...
                <div class="panel-body">
                    <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-highlight">
                            <li class=""><a href="#highlighted_tab1" data-toggle="tab" aria-expanded="false">Active</a></li>
                            <li class="active"><a href="#highlighted-tab2" data-toggle="tab" aria-expanded="true">Inactive</a></li>
                            {{--<li class="dropdown">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="highlighted_tab1">

                            </div>

                            <div class="tab-pane active" id="highlighted-tab2">
