    ...
    <div class="panel panel-default">
        ...
        <div class="datatable-footer">
            <div class="col-md-12">
                <div style="text-align: right;clear: both;">
                    <label class="control-label col-md-6"
                           style="font-size: 15px; margin-top: 6px;"><b>@lang('string.amountPrice')</b></label>
                    <div class="col-md-6">
                        <input type="text" placeholder="បញ្ចូលតំលៃទីនេះ..." name="" id="priceAmount"
                               class="form-control" style="border: 1px solid grey;">
                        <br>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                ...
                <div class="dataTables_length" id="DataTables_Table_3_length"
                     style="margin-top: -14px;margin-bottom: 7px;margin-right: 13px;">
                    <button type="button" class="btn btn-primary" id="btnSentToServer"
